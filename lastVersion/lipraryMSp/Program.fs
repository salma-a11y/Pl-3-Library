...
let addBook title author genre =
    if library.ContainsKey(title) then
...
let addBookPanel = new Panel(Top = 10, Left = 20, Width = 400, Height = 340, BackColor = System.Drawing.Color.Beige)
let searchPanel = new Panel(Top = 360, Left = 20, Width = 400, Height = 180, BackColor = System.Drawing.Color.Beige)
let booksDisplayPanel = new Panel(Top = 10, Left = 450, Width = 1100, Height = 530, BackColor = System.Drawing.Color.Beige)
...
let titleTextBox = new TextBox(Top = 90, Left = 80, Width = 300, Font = new System.Drawing.Font("Arial", 10.0f), RightToLeft = RightToLeft.No)
let authorLabel = new Label(Text = "Author:", Top = 130, Left = 10, Font = new System.Drawing.Font("Arial", 10.0f))
let authorTextBox = new TextBox(Top = 170, Left = 80, Width = 300, Font = new System.Drawing.Font("Arial", 10.0f), RightToLeft = RightToLeft.No)
let genreLabel = new Label(Text = "Genre:", Top = 210, Left = 10, Font = new System.Drawing.Font("Arial", 10.0f))
let genreTextBox = new TextBox(Top = 250, Left = 80, Width = 300, Font = new System.Drawing.Font("Arial", 10.0f), RightToLeft = RightToLeft.No)
let addButton = new Button(Text = "Add Book", Top = 290, Left = 120, Width = 160, Height = 40, BackColor = System.Drawing.Color.HotPink, ForeColor = System.Drawing.Color.White, Font = new System.Drawing.Font("Arial", 12.0f, System.Drawing.FontStyle.Bold))
...
let searchButton = new Button(Text = "Search", Top = 90, Left = 10, Width = 90, Height = 40, BackColor = System.Drawing.Color.HotPink, ForeColor = System.Drawing.Color.White, Font = new System.Drawing.Font("Arial", 12.0f))
let borrowButton = new Button(Text = "Borrow", Top = 90, Left = 110, Width = 90, Height = 40, BackColor = System.Drawing.Color.HotPink, ForeColor = System.Drawing.Color.White, Font = new System.Drawing.Font("Arial", 12.0f))
let returnButton = new Button(Text = "Return", Top = 90, Left = 210, Width = 90, Height = 40, BackColor = System.Drawing.Color.HotPink, ForeColor = System.Drawing.Color.White, Font = new System.Drawing.Font("Arial", 12.0f))
...
let booksListBox = new ListBox(Top = 50, Left = 10, Width = 1060, Height = 430, Font = new System.Drawing.Font("Arial", 25.0f))

// Status Label (Message area)
let statusLabel = new Label(Top = 550, Left = 20, Width = 1600, Height = 230, BackColor = System.Drawing.Color.Beige, Font = new System.Drawing.Font("Arial", 20.0f), TextAlign = System.Drawing.ContentAlignment.MiddleCenter)
